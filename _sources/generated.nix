...
}:
{
  ...
  cmux = {
    ...
    version = "0.64.25";
    src = fetchurl {
      url = "https://github.com/manaflow-ai/cmux/releases/download/v0.64.25/cmux-macos.dmg";
      sha256 = "sha256-zTAwDBAJXmIZchxl3SbKKphvjgChD5YNusn+++SHccE=";
    };
  };
  eclipse-java = {
    pname = "eclipse-java";
  ...
  tmux-nerd-font-window-name = {
    ...
    version = "c4a8baf3dc35707aa568eb2a69e270fc16728b71";
    src = fetchFromGitHub {
      owner = "joshmedeski";
      repo = "tmux-nerd-font-window-name";
      rev = "c4a8baf3dc35707aa568eb2a69e270fc16728b71";
      fetchSubmodules = false;
      sha256 = "sha256-9bLwV3Z3RYFqqlwy6WpKbyYs52bw4IFtmynkp7Hmzlo=";
    };
    date = "2026-09-21";
  };
  tmux-open-nvim = {
